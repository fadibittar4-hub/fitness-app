...
export class PaymentPage {
  ...
  readonly paymentSucceeded = signal(false);
      ...
      .subscribe({
        next: (res) => {
          ...
          if (res.data.status === 'paid') {
            ...
            this.successMessage.set('Payment successful. Your session is confirmed.');
            this.paymentForm.reset({ cardholderName: '', cardNumber: '', expiryDate: '', cvv: '' });
          } else {
